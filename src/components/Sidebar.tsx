...
const Sidebar: React.FC = () => {
  ...
  const handleEditProject = async () => {
    ...
    try {
      const updatedProject = await api.updateProject(editProjectId!, {
  ...
  const menu = (
    ...
    <Menu>
      ...
      <Menu.Item key="2" onClick={() => toggleFavorite(projectId, !isFavorite)}>
        {isFavorite ? "Remove from Favorites" : "Add to Favorites"}
      </Menu.Item>
      <Menu.Item key="3" onClick={() => handleDeleteProject(projectId)}>
        Delete
      </Menu.Item>
    </Menu>
  );
      ...
      >
        ...
        >
          ...
          <Button
            ...
            style={{ backgroundColor: "#ff9933", borderColor: "#ff9933" }}
          />
        </div>
        ...
        <List
          ...
          renderItem={(project) => (
            ...
            >
              ...
              <Dropdown
                overlay={menu(project.id, project.name, project.isFavorite)}
                trigger={["click"]}
              >
                <MoreOutlined
      ...
      <Layout style={{ padding: "16px", flex: 1, backgroundColor: "#fff" }}>
        {selectedProject && (
          <Todoist
            ...
            allProjects={projects.filter((p) => p.id !== selectedProject.id)}
          />
        )}
      </Layout>
    </Layout>
